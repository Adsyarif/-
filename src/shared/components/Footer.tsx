...
const Footer = () => {
  return (
    <div className="bg-black px-4 pt-[75px] pb-[32px]">
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="text-gray-300 text-sm bg-[#717FE0] w-1/2 p-3 rounded-full font-bold">
            SUBSCRIBE
          </button>
        </div>
      </div>

      <div className="text-gray-500 text-xs mt-12 text-center">
        Copyright &copy;2024 All rights reserved ドリ-ドリ
      </div>
    </div>
  );
};
